...
class DebugCalibrationTab(ttk.Frame):
    ...
    def __init__(self, delegate, container, debug_calibration_type: DebugCalibrationType):
        ...
        self.bottom_container.grid(row=1, column=0, sticky="wnes")
    ...
    def createCloseButton(self):
        ttk.Button(self.bottom_container, text="Close", pad=(40, 20), style="Settings.TButton", command=self.onCloseClicked) \
