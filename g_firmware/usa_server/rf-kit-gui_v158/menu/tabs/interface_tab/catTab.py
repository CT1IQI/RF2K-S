...
from operational_interface.catSupport import SupportedManufacturer, SupportedRig, get_configured_manufacturer_and_rig_and_baud_rate
...
class CatTab(ttk.Frame):
    def __init__(self, delegate, container):
        ...
        self.appliedManufacturer, self.appliedRig, self.appliedBaudRate = get_configured_manufacturer_and_rig_and_baud_rate()
