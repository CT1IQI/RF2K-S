...
class InterfaceWrapper:
    ...
    def set_nominal_power_supply_voltage(self, nominal_voltage):
        self._run_in_process("set_nominal_power_supply_voltage", nominal_voltage)

    def initialize_power_supply_current_limits(self):
        self._run_in_process("initialize_power_supply_current_limits")
    ...
    def get_autotune_return_loss_threshold(self):
        return self._run_in_process("get_autotune_return_loss_threshold")

    def set_autotune_return_loss_threshold(self, threshold):
        self._run_in_process("set_autotune_return_loss_threshold", threshold)
    ...
    def save_dac_value_input_offsets(self):
        self._run_in_process("save_dac_value_input_offsets")
    ...
    def set_10_12_15_m_gap_power_allowed(self, allowed):
        self._run_in_process("set_10_12_15_m_gap_power_allowed", allowed)
