...
def initThemes(app):
    ...
    style.configure("Antenna.Toolbutton", foreground="#ffffff", background='#666666',anchor='CENTER',
    ...
    style.configure("Disabled.Small.Button.Tuner.TLabel", foreground="#666666")
    ...
    style.configure("Disabled.Big.Button.Tuner.TLabel", foreground="#666666")
    ...
    style.configure("Antenna.Config.TEntry", foreground="#344b98")
    ...
    style.configure("Small.Menu.TNotebook.Tab", font=getStyleFontFromTkFont(font_small_bold))
