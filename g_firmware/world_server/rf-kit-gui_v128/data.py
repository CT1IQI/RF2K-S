...
class Data:
    ...
    def __init__(self):
        self.guiVersion = 128
        self.minimumControllerVersion = 140

        self.ftpConfig = None

        self.defaultAntennas = None

        self.maxDigitsValue = 0
        ...
        self.generation = Generation(interface.get_generation())
        ...
        self.defaultAntennas = interface.get_default_antennas()
        self.externalAntennaHighLowActive = interface.get_ext_antenna_high_low_active()
    ...
    def init_and_check_controller_version(self):
        actual_controller_version = interface.get_all_values()[0]
    ...
    def fetch_data_job(self):
        ...
        self.fetchDataJob = self.fetchJobMaster.after(20, self.fetch_data_job)
    ...
    def updateFilter(self):
        self.filter = interface.get_filter()

    def updateBIASPercentage(self):
        self.biasPercentage = interface.get_offset_BIAS()
    ...
    def updateAllValues(self):
        self.maxDigitsValue = interface.get_max_digits_value()
        result = interface.get_all_values()
    ...
    def updateAllVars(self):
        self.vars.version.set("(RF-KIT PA Version G{:d}C{:d} © 2019-2021 by RF-KIT)".format(self.guiVersion, self.version))
