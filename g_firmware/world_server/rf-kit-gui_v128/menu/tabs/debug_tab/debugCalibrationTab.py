...
class DebugCalibrationTab(ttk.Frame):
    ...
    def update_digit(self, filter_key: Band, digits_var: IntVar = None):
        ...
        current_digits = interface.get_dac_offset(self.debugCalibrationType, filter_key)
    ...
    def keep_incrementing_dac(self, filter_key):
        interface.increment_dac_offset(self.debugCalibrationType, filter_key)
    ...
    def keep_decrementing_dac(self, filter_key):
        interface.decrement_dac_offset(self.debugCalibrationType, filter_key)
