...
TX_SET_AUTOTUNE_POWER_ABILITY = "transceiver_can_set_power_for_autotune"
...
class Config:
    ...
    def __init__(self):
        ...
        self.transceiverCanSetPowerForAutotuneVar = BooleanVar(
            value=self.load_with_default(TX_SET_AUTOTUNE_POWER_ABILITY, False));
    ...
    def saveTxInterfaceSettings(self):
        self.save(TX_SET_AUTOTUNE_POWER_ABILITY, self.transceiverCanSetPowerForAutotuneVar.get())
